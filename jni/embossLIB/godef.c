...
/* @prog godef ****************************************************************
**
** Find gene ontology 'data' (identifier) terms by keyword
**
******************************************************************************/
...
int main(int argc, char **argv)
{
    ...
    /* Application logic */
    /* Check gene ontology (gene_ontology.*.obo) is installed indexed.
    ...
    {
        ajFmtPrintS(&oboqry, "go-des:%S", qrystr);
