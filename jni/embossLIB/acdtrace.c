...
/* @prog acdtrace *************************************************************
**
** ACD file compiler and trace.
**
** Unlike other ACD report programs (acdpretty and acdtable) acdtrace will run
** through command line checking and prompting the user, while logging the
** internal data.
**
** acdtrace reports the values of all ACD types, and also reports the
** resulutions of variables and functions at the point where they occur.
**
******************************************************************************/
