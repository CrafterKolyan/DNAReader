/** @source ontogetobsolete
**
** Get ontology ontology term(s) 
**
...
/* @prog ontogetobsolete ******************************************************
**
** Get ontology obsolete term(s)
**
******************************************************************************/
...
int main(int argc, char **argv)
{
    ...
    /* ACD processing */
    embInit("ontogetobsolete", argc, argv);
    ...
    if(!ifound)
        ajErr("No matching obsolete terms");
