...
int main(int argc, char **argv, char **env)
{
    ...
    newlist = ajListNew();
    if(alphabetic)
        embGrpSearchProgsEdam(newlist, alpha, search, "input",
                              sensitive, subclasses, obsolete);
    else
        embGrpSearchProgsEdam(newlist, glist, search, "input",
                              sensitive, subclasses, obsolete);
