/* @source wosstopic application
**
** Finds programs by topics in their application definition
**
...
int main(int argc, char **argv, char **env)
{
    ...
    newlist = ajListNew();
    if(alphabetic)
        embGrpSearchProgsEdam(newlist, alpha, search, "topic",
                              sensitive, subclasses, obsolete);
    else
        embGrpSearchProgsEdam(newlist, glist, search, "topic",
                              sensitive, subclasses, obsolete);
